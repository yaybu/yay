# -*- coding: utf-8 -*-
#
# yay documentation build configuration file, created by
...
release = pkg_resources.get_distribution('yay').version
...
latex_documents = [
  ('index', 'yay.tex', u'yay Documentation',
   u'John Carr', 'manual'),
]
